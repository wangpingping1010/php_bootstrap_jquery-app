...
$lang['receivings_transfer_id'] = '转移ID';
$lang['receivings_confirm_convert_sale_to_return'] = '您是否要将此接收转换为返回/转移？';
$lang['receivings_confirm_convert_return_to_sale'] = '您想将此退货/转让转换为销售吗？';
$lang['receivings_lookup_receipt'] = '查询收据';
$lang['receivings_receiving_id_not_found'] = '收不到';
$lang['receivings_transfer_qty_must_be_negative'] = '进行转移时，数量必须为负数。我们已经为您做出了这一改变。';
?>